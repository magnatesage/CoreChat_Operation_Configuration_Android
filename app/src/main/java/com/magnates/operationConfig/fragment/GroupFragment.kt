...
import com.magnates.operationConfig.adapter.PublicGroupAdapter
import com.magnates.operationConfig.adapter.SupportGroupAdapter
import com.magnates.operationConfig.databinding.FragmentGroupBinding
...
class GroupFragment : BaseFragment() {
    ...
    override fun init() {
        ...
        binding.tvPublicGroup.text = Utils.dynamicUIModel!!.dashboard.mainTab2.subGroup1.textValue + " " + context?.getString(
            R.string.group)
